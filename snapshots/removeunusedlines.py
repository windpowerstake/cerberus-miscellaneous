...
input_file_path = "result_export_cerb_block_4574265.csv"
output_file_path = "result_export_cerb_block_4574265v2.csv"

with open(input_file_path, "r") as input_file, open(output_file_path, "w") as output_file:
    for line in input_file:
        if not any(value in line for value in values_to_delete):
            output_file.write(line)

input_file_path = "export_cerb_block_4574265.txt.csv"
output_file_path = "export_cerb_block_4574265v2.txt.csv"
